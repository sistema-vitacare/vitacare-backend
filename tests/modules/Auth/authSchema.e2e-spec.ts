...
import { PasswordResetRepository } from '@/modules/Auth/repositories/passwordReset.repository';
...
/** Raiz de `src/`, a partir deste arquivo em `tests/modules/Auth/`. */
...
describeWithDatabase('autenticacao em PostgreSQL descartavel', () => {
  ...
  beforeAll(async () => {
    ...
    dataSource = new DataSource({
      type: 'postgres',
      url: databaseUrl,
      // Glob, e nao lista fixa: uma entidade nova sem migration precisa
      // aparecer na verificacao de schema abaixo.
